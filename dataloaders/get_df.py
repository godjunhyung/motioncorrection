...
def split_df(df, save_root):
    ...
    train_df_path = save_root + 'fr-iqm_train.csv'
    test_df_path = save_root + 'fr-iqm_test.csv'
...
def get_df_v1(cfg, is_train=False):
    ...
    if cfg.dataset_name == 'Simulation':
        ...
        split_df(df, cfg.datasplit_root)
